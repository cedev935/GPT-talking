...
export const HomeScreen = () => {
    ...
    Voice.onSpeechEnd = (e) => setInputValue( console.warn("1"+e));
    Voice.onSpeechError = (e) => setInputValue( console.warn(e));
    Voice.onSpeechPartialResults = (e) => setInputValue( console.warn("3"+e));
    Voice.onSpeechRecognized = (e) => setInputValue( console.warn("4"+e));
